...
PHRASE_ASK_FOR_GUESS = {"russia":"Угадайте текст написанный человеком. Введите номер текста.","english":"Guess the sentence written by the human. Type the number of text."}
...
PHRASE_INDEX_ERROR_1 = {"russia":"Ошибка индекса (Ожидалось число)", "english": "Index error (Number expected)"}
PHRASE_INDEX_ERROR_2 = {"russia":"Ошибка индекса (Число за границей выбора)", "english": "Index error (Number is out of choice bounds)"}